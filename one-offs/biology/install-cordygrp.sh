...
export ENVIRONMENT=${SOFTWARE}/env-cordygrp
...
metaphlan --install --db_dir ${ENVIRONMENT}/databases
...
setenv  PIXI_PROJECT_NAME           "env-cordygrp"
...
setenv  PIXI_PROMPT                 "(env-cordygrp) "
setenv  CONDA_DEFAULT_ENV           "env-cordygrp"
setenv  CONDA_PREFIX                "\${basedir}/\${environment}/.pixi/envs/default"
setenv  HYDRA_FULL_ERROR            1

setenv METAPHLANDBS  "\${basedir}/\${environment}/databases"
