...
**Usage of the DEAC Cluster by WFU affiliated parties outside of the WFU UC/GSAS, such as the School of Medicine, is provided only in a PAID USAGE format. See :ref:`su-chargebacks<Chargebacks under Service Units>` for more information on how usage payments are calculated and made.**
